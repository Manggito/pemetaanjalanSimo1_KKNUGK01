...
lyr_FASILITASUMUM_6.set('fieldAliases', {'Id': 'Id', 'NAMA': 'NAMA', });
lyr_INFORMASI_7.set('fieldAliases', {'Id': 'Id', 'KETERANGAN': 'KETERANGAN', 'NAMA': 'NAMA', 'NO_TLF': 'NO_TLF', });
...
lyr_FASILITASUMUM_6.set('fieldImages', {'Id': 'Range', 'NAMA': 'TextEdit', });
lyr_INFORMASI_7.set('fieldImages', {'Id': 'Range', 'KETERANGAN': 'TextEdit', 'NAMA': 'TextEdit', 'NO_TLF': 'TextEdit', });
...
lyr_FASILITASUMUM_6.set('fieldLabels', {'Id': 'hidden field', 'NAMA': 'header label - visible with data', });
lyr_INFORMASI_7.set('fieldLabels', {'Id': 'hidden field', 'KETERANGAN': 'header label - visible with data', 'NAMA': 'inline label - visible with data', 'NO_TLF': 'header label - visible with data', });
